-- Reassert related/smart recommendation compatibility v4 in production.
-- The public site must not trust vector similarity alone across editorial
-- worlds. A public-affairs episode may mention "Isten" metaphorically, and a
-- business/sermon/kids/sport candidate still needs explicit shared evidence.
