-- Consolidated clean-text backfill gate.
-- Legacy deterministic_v3 rows must not be globally reprocessed until sampled
-- quality proof shows that deterministic_v4/AI-trim is better and not
-- overcutting. The RPC stays available for bounded manual canaries.
