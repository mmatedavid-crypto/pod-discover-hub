-- Consolidated people identity-safety policy.
-- Person names are ambiguous in Hungarian media data. Public hubs and
-- prerendered SEO/AI crawler HTML must receive enough identity fields to avoid
-- publishing stale or wrong biographies for unverified same-name people.
