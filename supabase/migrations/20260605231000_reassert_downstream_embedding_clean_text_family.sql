-- Reassert downstream embedding candidate selection after production drift:
-- both episode-level and chunk-level embedding queues must accept promoted
-- deterministic_v4-family clean text, not only exact deterministic_v4 rows.
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'reasserted_by', '20260605231000_reassert_downstream_embedding_clean_text_family',
