-- Expand publisher article matching beyond Telex/444.
-- These sources can provide richer episode descriptions than RSS, but article
-- matches still require title/date/body evidence before becoming best text.
  ...
  jsonb_build_object(
    ...
    'sources', jsonb_build_array(
      ...
      jsonb_build_object(
        ...
        'feed_urls', jsonb_build_array(
          'https://hvg.hu/rss',
          'https://hvg.hu/rss/podcast'
        ),
        'listing_urls', jsonb_build_array(
          'https://hvg.hu/podcastok',
          'https://hvg.hu/itthon/podcast',
          'https://hvg.hu/gazdasag/podcast',
          'https://hvg.hu/tudomany/podcast'
        ),
      ...
      jsonb_build_object(
        ...
        'listing_urls', jsonb_build_array(
          'https://www.portfolio.hu/podcast',
          'https://www.portfolio.hu/uzlet/podcast'
        ),
      ...
      jsonb_build_object(
        ...
        'listing_urls', jsonb_build_array(
          'https://hold.hu/holdblog/',
          'https://hold.hu/holdblog/tag/podcast/',
          'https://hold.hu/holdblog/tag/hold-after-hours/'
        ),
      ...
      jsonb_build_object(
        'outlet', 'partizan',
        'feed_urls', jsonb_build_array(
          'https://www.partizan.hu/rss.xml'
        ),
        'listing_urls', jsonb_build_array(
          'https://www.partizan.hu/podcastok',
          'https://www.partizan.hu/blog'
        ),
