-- Reassert publisher article-pairer patterns as brand/show anchors only.
-- Generic topic words in podcast_title_patterns over-broaden episode lookup and
-- can create false article matches even when the runtime scorer is conservative.
