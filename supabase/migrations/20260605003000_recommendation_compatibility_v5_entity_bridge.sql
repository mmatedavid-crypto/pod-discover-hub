...
VALUES (
  ...
  jsonb_build_object(
    ...
    'note', 'Cross-podcast recommendations need explainable topic/person/company evidence unless both sides are the same specific editorial group or exceptionally close general content.'
  ),
  now()
)
