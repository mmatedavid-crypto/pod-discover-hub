-- Reassert publisher article-pairer source config after production drift left
-- only five sources active and no persisted article candidates. Keep matching
-- conservative; improve source coverage and run breadth instead.
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'article_pairer_limit', 220,
    'article_pairer_sources_per_run', 3,
