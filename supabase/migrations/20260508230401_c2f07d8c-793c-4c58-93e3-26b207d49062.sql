  ...
  SELECT jsonb_build_object(
    ...
    'remaining_needing_change', (
      SELECT count(*) FROM scored
       WHERE rank_label IS NULL OR shadow_rank IS NULL
...
REVOKE EXECUTE ON FUNCTION public.formula_c_status() FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.formula_c_status() TO authenticated, service_role;