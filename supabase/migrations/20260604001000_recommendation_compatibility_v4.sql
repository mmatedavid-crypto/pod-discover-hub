-- Tighten related/smart recommendation compatibility.
-- Different editorial worlds may look close in embedding space when RSS text is
-- noisy. Cross-world recommendations need explicit shared topic/entity evidence.
