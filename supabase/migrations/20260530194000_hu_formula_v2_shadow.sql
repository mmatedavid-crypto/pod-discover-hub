-- HU Formula v2 shadow scoring support.
-- Fully automatic: no manual seed set, no AI spend. The runner writes only
-- podcasts.shadow_rank_components.hu_v2 until explicitly promoted later.
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'components', jsonb_build_object(
      ...
      'trust', 1.3,
      'freshness', 1.2,
      'category_activity', 1.3,
      'content_intelligence', 1.6,
      'platform_availability', 0.7,
      'distinctiveness', 0.6,
      'curation', 0.3
    ),
