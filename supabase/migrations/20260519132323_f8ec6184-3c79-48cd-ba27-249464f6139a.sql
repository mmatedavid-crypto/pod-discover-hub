  ...
  scored AS (
    SELECT b.id, b.title, b.slug, b.podiverzum_rank,
      CASE
        ...
        -- For SHORT brand-typing queries, prefix-match indicates clear intent
        -- and should outrank token matches buried mid-title.
        ...
        -- For longer multi-word queries, token-as-whole-word stays strongest.
