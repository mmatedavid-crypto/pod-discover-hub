-- The consumer homepage has one discovery block for situations/moods.
-- Mobile stays focused, while tablet/desktop can show more relevant
-- listening situations now that the duplicate "Merre indulnál?" rail is gone.
