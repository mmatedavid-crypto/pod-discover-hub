-- Keep the legacy single-episode embedding path clean-text-first too.
-- The active chunk embedder already requires promoted deterministic_v4 clean text;
-- this prevents an accidental future re-enable of embed-episode-runner from using
-- raw RSS/YouTube descriptions.
