...
GRANT SELECT ON public.search_external_demand_seeds TO anon;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.search_external_demand_seeds TO authenticated;
GRANT ALL ON public.search_external_demand_seeds TO service_role;
