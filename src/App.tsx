...
const AdminSpotifyTranscriptPage = lazy(() => import("./pages/AdminSpotifyTranscriptPage.tsx"));
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/admin/spotify-transcripts" element={<AdminSpotifyTranscriptPage />} />
          ...
          <Route path="/company/:slug/temak/:topicSlug" element={<RedirectWithTwoSlugs to="/ceg" />} />
