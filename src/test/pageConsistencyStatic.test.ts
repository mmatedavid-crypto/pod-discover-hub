...
describe("page consistency static guards", () => {
  ...
  it("keeps public SEO surfaces behind the Hungarian text sanitizer", () => {
    ...
    expect(podcast).toContain("const PODCAST_SEO_CTA = \"Hallgasd ingyen, regisztráció nélkül a Podiverzumon.\"");
    ...
    expect(prerender).toContain("const PODCAST_SEO_CTA = \"Hallgasd ingyen, regisztráció nélkül a Podiverzumon.\"");
