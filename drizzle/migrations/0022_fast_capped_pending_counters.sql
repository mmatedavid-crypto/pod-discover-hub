-- The entity-backfill and classifier queues are large joins; an exact count times out.
-- The controller only needs the size band, so cap the scan at 20001 rows.
